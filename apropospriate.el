...
(defmacro apropospriate-with-color-variables (variant &rest body)
  ...
  `(let* ((class '((class color) (min-colors 89)))
          (variant ,variant)
          (base00   (if (eq variant 'light) "#FFFFF0" "#202020"))
...
(defun create-apropospriate-theme (variant theme-name)
  ...
  (apropospriate-with-color-variables variant
    (custom-theme-set-faces
     ...
     `(git-gutter:added ((,class (:foreground "#3C3CB3B37171"))))
     `(git-gutter:deleted ((,class (:foreground "#CDCD5C5C5C5C"))))
     `(git-gutter:modified ((,class (:foreground "#1E1E9090FFFF"))))
